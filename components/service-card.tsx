...
export default function ServiceCard({ service, index, inView }: ServiceCardProps) {
  ...
  if (isImageCard) {
    return (
      <div
        className={`card-hover reveal ${delayClass} ${inView ? "in-view" : ""} group relative rounded-2xl overflow-hidden min-h-[280px] flex items-end`}
      >
