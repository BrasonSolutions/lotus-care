...
// This project has no shadcn scaffolding (no `@/lib/utils`, no `clsx`/
// `tailwind-merge`) — a plain filter+join covers every conditional className
// this component needs, so no new dependency is pulled in for it.
    ...
    >
      <div className="relative">
        <div
          ...
          // `focus-ring` is this project's own focus style (see globals.css) —
          // swapped in for the shadcn `ring-ring` token, which isn't defined here.
          className="cursor-grab overflow-hidden py-10 focus-ring active:cursor-grabbing"
          style={{
